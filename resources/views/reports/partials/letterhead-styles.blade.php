...
.document-footer { position: fixed; bottom: 10px !important; left: 0; right: 0; border-top: .6px solid #d9c9c0; padding-top: 3px; font-size: 11px; line-height: 1.12; color: #5f5a55; display: table; width: 100%; table-layout: auto; }
.document-footer-qr { display: table-cell; width: 79px; height: 72px; padding-right: 7px; vertical-align: middle; }
.document-footer-qr img { display: block; width: 72px; height: 72px; object-fit: contain; }
...
.document-footer-issuance { white-space: nowrap; }
