<form method="POST" action="{{ $action }}" class="sge-concept-form">
    ...
    <div class="form-row">
        <div class="form-group col-sm-6 col-lg-2">
            <label for="concept_sort_order_{{ $concept->id ?? 'new' }}">{{ __('Ordem') }}</label>
            <input
                ...
                required
            >
            @error('sort_order') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
        </div>

        <div class="form-group col-lg-4">
            <label for="concept_name_{{ $concept->id ?? 'new' }}">{{ __('Nome do conceito') }}</label>
            <input
        ...
        <div class="form-group col-sm-6 col-lg-2">
            <label for="concept_abbreviation_{{ $concept->id ?? 'new' }}">{{ __('Abreviatura') }}</label>
            <input
                ...
                required
            >
            @error('abbreviation') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
        </div>

        <div class="form-group col-lg-4">
            <label for="concept_effective_from_{{ $concept->id ?? 'new' }}">{{ __('Vigente a partir de') }}</label>
            <input
    ...
    <div class="form-row align-items-end">
        <div class="form-group col-sm-6 col-lg-3">
            <label for="concept_minimum_score_{{ $concept->id ?? 'new' }}">{{ __('Nota mínima') }}</label>
            <input
            ...
            >
            @error('minimum_score') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
        </div>

        <div class="form-group col-sm-6 col-lg-3">
            <label for="concept_maximum_score_{{ $concept->id ?? 'new' }}">{{ __('Nota máxima') }}</label>
            <input
            ...
            >
            @error('maximum_score') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
        </div>
        ...
        <div class="form-group col-sm-6 col-lg-2">
            <div class="custom-control custom-checkbox sge-concept-check">
                ...
                <label for="concept_minimum_inclusive_{{ $concept->id ?? 'new' }}" class="custom-control-label">{{ __('Inclui mínima') }}</label>
            </div>
        </div>
        ...
        <div class="form-group col-sm-6 col-lg-2">
            <div class="custom-control custom-checkbox sge-concept-check">
                ...
                <label for="concept_maximum_inclusive_{{ $concept->id ?? 'new' }}" class="custom-control-label">{{ __('Inclui máxima') }}</label>
            </div>
        </div>
