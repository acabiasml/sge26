...
@section('title', __('screens.people'))
@section('page-title', __('screens.people'))

@section('page-actions')
    <a class="btn btn-sm btn-primary shadow-sm sge-icon-action" href="{{ route('people.create') }}" aria-label="{{ __('screens.register_person') }}" title="{{ __('screens.new_person') }}">
