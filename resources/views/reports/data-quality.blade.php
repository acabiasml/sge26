...
<head>
    ...
    <style>
        ...
        th { background: #6B3D2E; color: #fff; font-weight: bold; padding: 5px; text-align: left; }
        td { border-bottom: 1px solid #e5d8cf; padding: 4px 5px; vertical-align: top; }
        ...
        .badge { border-radius: 9px; color: #fff; display: inline-block; font-size: 8px; font-weight: bold; padding: 2px 6px; }
