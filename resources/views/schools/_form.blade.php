<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        @error('legal_name') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        @error('cnpj') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
    </div>
    ...
    <div class="form-group col-md-4">
        ...
        @error('inep') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
    </div>
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        @error('founded_at') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
    </div>
    ...
    <div class="form-group col-md-8">
        ...
        @error('website') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
    </div>
</div>
...
<div class="form-group">
    ...
    @error('letterhead_text') <div class="invalid-feedback">{{ __($message) }}</div> @enderror
</div>
...
<div class="form-row align-items-end">
    <div class="form-group col-md-8">
        ...
        @error('logo') <div class="invalid-feedback d-block">{{ __($message) }}</div> @enderror
    </div>
